    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "CEE0ABB0-E53A-44E2-8287-87A3DCE8E7E2", 0, "7cc5adc1-e8c1-4320-94e1-7bae49e66978", "IdentityUser", "InterView@email.com", true, false, null, "INTERVIEW@EMAIL.COM", "ADMIN", "AQAAAAIAAYagAAAAEPtQjST6jMbujM+rvmB5W4wpTY+E7EeqBz+L/hmCmiN9gVinJ0GBPfyQiBEt1QAx8w==", null, false, "", false, "admin" });

            migrationBuilder.InsertData(
                table: "Room",
                column: "RoomId",
                value: "706F3EBC-5B7E-43FB-AAD1-18305C90DF00");
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("607ed998-da08-11ed-afa1-0242ac120002"), new DateTime(2023, 6, 14, 2, 44, 43, 954, DateTimeKind.Local).AddTicks(3696), "706F3EBC-5B7E-43FB-AAD1-18305C90DF00", new DateTime(2023, 6, 14, 1, 44, 43, 954, DateTimeKind.Local).AddTicks(3682), "За кадром: жизнь и карьера режиссера", "CEE0ABB0-E53A-44E2-8287-87A3DCE8E7E2" });
